...
<head>
    ...
    <title>Votre paiement a bien été recu !</title>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        ...
                                        <h1><strong>Je suis David YAO, Fondateur de Rikudo Technologies</strong></h1>

                                        <h3>Je t'envoie ce mail pour te confirmer de la bonne réception de
                                        ton paiement. Nous nous occupons de ton projet immédiatement :)</h3>
                                    </td>
                                </tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                    <h3><strong>Ce mail sert de preuve de paiement pour votre achat. Merci de le conserver
                                                    ainsi que d'y joindre la capture d'écran du recu d'achat effectué sur notre site, pour toute
                                                  éventuelle réclamation.</strong></h3>
                                                    <h4></h4>
                                                </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" id="templateContainerMiddleBtm" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-11">
                                        <h3><strong>Pour toute autre information, écris à</strong></h3>

                                        <h4></h4><a class="blue-btn" href="mailto:info@oschool.ci"><strong>info@oschool.ci</strong></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END BODY -->
