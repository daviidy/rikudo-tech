...
<head>
    ...
    <title>Nouveau paiement pour Rikudo Technologies</title>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        ...
                                        <h1><strong>Il y a un nouveau paiement pour Rikudo Tehcnologies</strong></h1>

                                        <h3>Un client vient d'effectuer un paiement. Voici ses informations</h3>
                                    </td>
                                </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" id="templateContainerMiddleBtm" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-11">
                                        <h3><strong>Voir le tableau de bord !</strong></h3>

                                        <h4></h4><a class="blue-btn" href="https://cinetpay.com"><strong>Voir</strong></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END BODY -->
